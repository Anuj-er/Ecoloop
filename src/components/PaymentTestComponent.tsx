...
export const PaymentTestComponent = () => {
  ...
  const handlePaymentSuccess = (result: PaymentResult, co2Saved: number, material: string, quantity: number) => {
    console.log('Payment successful:', result);
    console.log('CO2 Impact:', { co2Saved, material, quantity });
    setLastPaymentResult(result);
    alert(`🎉 Payment Successful!\nTransaction ID: ${result.transactionId}\n🌱 CO2 Saved: ${co2Saved.toFixed(1)}kg from ${quantity}kg ${material}`);
  };
